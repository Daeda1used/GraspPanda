...
BASELINE_SLOTS = (
    ComponentSlot('backbone','view_estimator.backbone',('upstream','pointnet','pointnext','pointvector','pointmeta','pointmlp','pointmamba','pointcloud_mamba','octformer','sonata_ptv3','point_transformer_v2','litept'),
...
def slots(method):
    if method == 'economicgrasp': return (
        ComponentSlot('backbone', 'backbone', ('upstream', 'native_tdunet', 'pointnet', 'sonata_ptv3', 'point_transformer_v2','litept'),
    ...
    if method=='finegrasp':return (
        ComponentSlot('backbone','backbone',('upstream','sonata_ptv3','point_transformer_v2','litept'),
    ...
    if method=='graspness':return (ComponentSlot('backbone','backbone',('upstream','pointnet','sparse_unet18','sonata_ptv3','point_transformer_v2','litept'),
