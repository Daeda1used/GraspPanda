...
modules += ['flash_attn', '_grasppanda_pointrope_cuda', '_grasppanda_pointops', '_grasppanda_pointcept_cuda', 'ocnn', 'dwconv.core', '_grasppanda_gpg', 'fpsample', 'torch_cluster', '_grasppanda_pointmamba_scan', '_grasppanda_causal_conv1d', '_grasppanda_pcm_scan', '_grasppanda_pcm_causal']
for name in modules:
    try:
